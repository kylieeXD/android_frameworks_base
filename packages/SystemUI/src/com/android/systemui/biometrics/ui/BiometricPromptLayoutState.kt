...
/** Class for handling the layout of the Biometric Prompt */
data class BiometricPromptLayoutState(
    val activeView: BiometricPromptView,
    val position: PromptPosition,
    val size: PromptSize,
    val hideSensorIcon: Boolean,
